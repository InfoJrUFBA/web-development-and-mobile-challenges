//Run this program with node.js using the followuing command: node node-cli.js
...
read0.question("Insert 3 numerical values between 0 and 10, using up to one decimal place; separating each one by using spacebar\n", function(answer) {
